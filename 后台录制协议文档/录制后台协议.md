...
```json
{
    ...
    "class_groupid":"#TGS@6666",    //change 废弃？
    "userid":"teacher_001",
    "localtime":1267997317,
    "start_record":true         //change 是否在创建课堂时自动开始录制
}
```
...
```json
{
    "error_code":0,
    "error_msg":"",
    "classid":"Y2xhc3NpZF8xNDAwMDQyOTgyXzEy"    //change 废弃
}
```
...
```json
{
    ...
    "classid":"Y2xhc3NpZF8xNDAwMDQyOTgyXzEy",//change 修改为roomid
...
字段  | 类型  | 选项 | 说明
:-----: | :-----: | :-----: | :-----: 
classid|String|必填|如果使用了TICSDK,是创建课堂时返回的classid;如果没有使用TICSDK，则是调用create_class时录制后台返回的classid
...
```json
{
    ...
    "error_msg":"",
    "event_type":1000,
    "classid_list":[    //change 修改为roomid_list
        "MTQwMDA0Mjk4Ml93aWxkZXJfMTUyMTcyMjU0OA==" //change 修改为roomid
    ]
}
```
...
classid_list|Array|必填|开始录制的classid数组
...
```json
{
    ...
    "error_msg":"",
    "event_type":1001,
    "classid":"MTQwMDA0Mjk4Ml93aWxkZXJfMTUyMTcyMjU0OA==",//change 修改为roomid
    "class_starttime":1521685108,
    "class_endtime":1521685108,
    "file_id":1,
    "is_finish":false,
...
```json
{
    ...
    "classid":"MTQwMDA0Mjk4Ml8yMDAwXzE1MjE2ODUxMDhfMTUyMTcyMjU0OA=="//change 修改为roomid
}
```
...
```json
{
    "cmd":"open_record_svc",
    "sub_cmd":"re_record",
    "classid":"dGFza2lkXzE0MDAwNDI5ODJfMTI=",//change 修改为roomid
}
```
